...
class ReservaScreen2 extends StatefulWidget {
  final BicicletasDataModel bicicleta;

  const ReservaScreen2({Key? key, required this.bicicleta}) : super(key: key);

  @override
  _ReservaScreenState createState() => _ReservaScreenState();
}

class _ReservaScreenState extends State<ReservaScreen2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Reserva Planificada'),
